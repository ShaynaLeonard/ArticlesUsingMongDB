...
// parameters: article details are sent in the body. The required article details are id, heading, date of publication 
// summary and email of existing author (the email acts as a author id)
...
// parameters: review details are sent in the body (heading, content, likes and dislikes), and the article id in the URL  
// return value: appropriate status and message 
...
// description: deletes a review from an article according to articleId and review Id, the review id is the Object id that is generated by MongoDB
